from maze.formatter import (
    ...
    PNGImageSaver,
    ShapeFormatter,
    StringFormatter, ImageSaverFactory,
)
...
def gen_maze_image(rows=4, columns=8, outfilename="out/maze_shapes.png"):
    ...
    image_saver = ImageSaverFactory.create(outfilename)
...
if __name__ == "__main__":
    rows = 4
    columns = 8
    gen_maze_image(rows, columns, "out/maze_shapes.png")
    gen_maze_image(rows, columns, "out/maze_shapes.svg")
